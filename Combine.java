...
public class Combine {
    public static List<Object> combine(List<int[]> allocations, List<Integer> space, int[] shortfall, int backupSize, Set<Integer> used, int[] boundlst) {
        if (used == null) {
            used = new HashSet<>();
        }
        if (boundlst == null) {
    ...
    public static List<Object> threes(int[] shortfall, List<int[]> allocations, List<Integer> spaces, int backupSize, Set<Integer> used5, int[]boundlst) {
        if (boundlst == null) {
            boundlst = new int[]{0, 0};
        }
        if (used5 == null) {
    ...
    public static List<Object> combineFlipped(List<int[]> allocations, List<Integer> space, int[] shortfall, int backupSize, Set<Integer> used, int[] boundlst) {
        ...
        List<Object> trial = threesFlipped(allocations0, space0, new int[]{backup4, six4}, backupSize, used4, new int[]{upper, upper});
        if (!((List<?>) trial.get(1)).isEmpty()) {
