...
public class Combine {
    public List<Object> combine(List<int[]> allocations, List<Integer> space, int[] shortfall, int backupSize, Set<Integer> used, int[] boundlst) {
        if (used == null) {
            used = new HashSet<>();
        }
        if (boundlst == null) {
            boundlst = new int[]{0, 0};
        }
    ...
    public List<Object> threes(int[] shortfall, List<int[]> allocations, List<Integer> spaces, int backupSize, Set<Integer> used5, int[]boundlst) {
        if (boundlst == null) {
            boundlst = new int[]{0, 0};
        }
        if (used5 == null) {
        ...
        for (int m = lower; m < upperBound; m++) {
            ...
            for (int i = 0; i < filteredSpaces.size() - 2; i++) {
                if (six6 == 0 && backup6 == 0) break;
                for (int j = filteredSpaces.size() - 1; j > i + 1; j--) {
                    if (six6 == 0 && backup6 == 0) break;
                    for (int k = j - 1; k > i; k--) {
                        if (six6 == 0 && backup6 == 0) break;
    ...
    public static List<Object> combineFlipped(List<int[]> allocations, List<Integer> space, int[] shortfall, int backupSize, Set<Integer> used, int[] boundlst) {
        ...
        if (backupSize == 7) {
            for (int bound = lower; bound < upper; bound++) {
                ...
                List<Object> trial = threesFlipped(allocations0, space0, new int[]{backup4, six4}, backupSize, used4, new int[]{lower, upper});
                if (!((List<?>) trial.get(1)).isEmpty()) {
                    return Arrays.asList(mergeLists((List<int[]>) trial.get(0), combos4), mergeLists((List<int[]>) trial.get(1), init));
                }
                ...
                for (int m = 0; m < space0.size(); m++) {
                    ...
                    for (int n = space0.size() - 1; n > m; n--) {
                        ...
                        if ((space0.get(m) + space0.get(n) >= 7) && !used4.contains(m) && !used4.contains(n) && sum(allocations0.get(m)) + sum(allocations0.get(n)) <= bound) {
                            ...
                            trial = threesFlipped(allocations0, space0, new int[]{backup4, six4}, backupSize, used4, new int[]{lower, upper});
                            if (!((List<?>) trial.get(1)).isEmpty()) {
                                return Arrays.asList(mergeLists((List<int[]>) trial.get(0), combos4), mergeLists((List<int[]>) trial.get(1), init));
                            }
                        }
            ...
            for (int bound = lower; bound < upper; bound++) {
                ...
                List<Object> trial = threesFlipped(allocations0, space0, new int[]{backup4, six4}, backupSize, used5, new int[]{lower, upper});
                if (!((List<?>) trial.get(1)).isEmpty()) {
                    return Arrays.asList(mergeLists((List<int[]>) trial.get(0), combos5), mergeLists((List<int[]>) trial.get(1), init1));
                }
                ...
                for (int m = 0; m < space0.size(); m++) {
                    ...
                    for (int n = space0.size() - 1; n > m; n--) {
                        ...
                        if ((space0.get(m) + space0.get(n) >= 6) && !used5.contains(m) && !used5.contains(n) && sum(allocations0.get(m)) + sum(allocations0.get(n)) <= bound) {
                            ...
                            trial = threesFlipped(allocations0, space0, new int[]{backup4, six4}, backupSize, used5, new int[]{lower, upper});
                            if (!((List<?>) trial.get(1)).isEmpty()) {
                                return Arrays.asList(mergeLists((List<int[]>) trial.get(0), combos5), mergeLists((List<int[]>) trial.get(1), init1));
                            }
                        }
